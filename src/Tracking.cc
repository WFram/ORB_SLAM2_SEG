...
void Tracking::SetSegment(Segment* pSegment)
{
    mpSegment=pSegment;
}

void Tracking::SetDynamicCuller(DynamicCulling* pDynamicCuller)
{
    mpDynamicCuller = pDynamicCuller;
}
...
cv::Mat Tracking::GrabImageRGBD(const cv::Mat &imRGB,const cv::Mat &imD, const double &timestamp)
{
    ...
    mCurrentFrame = Frame(mImGray,imDepth,mpSegment->mImgSegmentLatest,timestamp,mpORBextractorLeft,mpORBVocabulary,mK,mDistCoef,mbf,mThDepth);
    Track();
